                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <c:forEach items="${clienteList}" var="cliente">
                                        <tr>
                                            <td><c:out value="${cliente.cliente_id}"/></td>
                                            <td><c:out value="${cliente.cpf}"/></td>
                                            <td><c:out value="${cliente.endereco}"/></td>
                                            <td><c:out value="${cliente.razao_social}"/></td>
                         ...
                         <div class="panel-body">
                            ...
                            <div>
                                <form action="ClienteController" method="POST">
		                           ...
		                           <div class="form-group">
		                                <button type="submit" class="btn btn-primary" id="updateCliente" name="updateCliente">Update</button>
		                                <button type="submit" class="btn btn-primary" id="deleteCliente" name="deleteCliente">Delete </button>
	                           		</div>
                               </form>
                           </div>
                           <!-- Update e Delete -->
