    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="home.jsp">SB Admin v2.0</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <div class="col-lg-12" id="add">
                        ...
                        <form action="FornecedorController" method="GET">
                           <div class="form-group">
                               ...
                               <input class="form-control" placeholder="Nome da Empresa" name="fRazaoSocial" size="30" maxlength="30">
                           </div>
                           <div class="form-group">
                               <label>CNPJ:</label>
                               <input class="form-control" placeholder="00.000.000/0000-00" name="fCnpj" size="30" maxlength="30">
                           </div>
                           <div class="form-group input-group">
                               <span class="input-group-addon">@</span>
                               <input type="text" class="form-control" placeholder="exemplo@gmail.com" name="fEmail">
                           </div>
                           <div class="form-group">
                               <label>Endereco:</label>
                               <input class="form-control" placeholder="Av. do Exemplo" name="fEndereco" size="30" maxlength="30">
                           </div>
                           <div class="form-group">
                               <label>Telefone:</label>
                               <input class="form-control" placeholder="(00)00000.0000" name="fTelefone" size="30" maxlength="30">
                           </div>
                           <div class="form-group">
