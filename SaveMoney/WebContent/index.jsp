...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center inner">
                    <div class="animatedParent">
                        <h1 class="animated fadeInDown">Seja Bem Vindo!</h1>
                        <p class="animated fadeInUp">Uma administração financeira feita pra você e para sua empresa</p>
                    </div>
               </div>
              </div>
              <div class="row">
        ...
        <nav class="navbar navbar-custom" role="navigation">
                              <div class="container">
                                    <div class="row">
                                          <div class="col-md-2">
                                                   <div class="site-logo">
                                                            <a href="home.html" class="brand">SaveMoney</a>
                                                    </div>
                                          </div>
        ...
        <div class="container marginbot-50">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <h2 class="h-bold">Nossa Missão</h2>
            ...
            <div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="service-box">
                    ...
                    <div class="service-desc">                      
                        ...
                        <div class="divider-header"></div>
                        <p>
                        Chega de ferramentas complicadas para você e sua equipe, com SaveMoney você irá desfrutar de uma experiência incrível com nosso deing intuitivo.
                        </p>
            ...
            <div class="col-xs-6 col-sm-4 col-md-4">
                ...
                <div class="service-box">
                    ...
                    <div class="service-desc">
                        ...
                        <div class="divider-header"></div>
                        <p>
                        Trabalhamos com as tecnologias de ponta do mercado, garantindo assim que seus dados fiquem protegidos e sempre a sua disposição.
                        </p>
                        <a href="#" class="btn btn-skin">Learn more</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <p>&copy;Copyright 2017 - SaveMoney. <a href="http://bootstraptaste.com/">SaveMoney</a> by SaveMoney</p>
                    <!-- 
    ...
    <script src="bootstrap/http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
