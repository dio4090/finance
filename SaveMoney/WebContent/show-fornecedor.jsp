...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Lista de Fonecedores</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                         ...
                         <div class="panel-body">
                            ...
                            <div>
                                ...
                                <form action="FornecedorController" method="POST">
                                    ...
                                    <select name="id">
                                       <c:forEach items="${fornecedorList}" var="fornecedor">
                                           <option value="${fornecedor.fornecedor_id}">${fornecedor.fornecedor_id}</option>
                                       </c:forEach>
                                    </select>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <button type="submit" id="updateFornecedor" name="updateFornecedor"> Update</button>
