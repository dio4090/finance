            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12" id="add">
                        <h1 class="page-header">Adicionar Modulo de Recebimento</h1>
                        <form action="ModuloRecebimetnoController" method="GET">
                        	<h2>Listar Notas Fiscais</h2>
                           <div>
                                <input type="submit" class="btn btn-primary" name="showNotaFiscalModR" value="Listar"> &nbsp; &nbsp;<br>
                           </div>
                           <select name="id">
                              <c:forEach items="${notaFiscalList}" var="notaFiscal">
                                  <option value="${notaFiscal.nota_fiscal_id}">${notaFiscal.nota_fiscal_id}</option>
                              </c:forEach>
                           </select>
                           
                           <div class="form-group">
                                <input type="submit" class="btn btn-primary" name="addModuloRecebimento" value="Add">
                           </div>
                        </form>
