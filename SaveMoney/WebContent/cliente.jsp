                    ...
                    <div class="col-lg-12" id="add">
                        ...
                        <form action="ClienteController" method="GET">
                           ...
                           <div class="form-group">
                               ...
                               <input class="form-control" placeholder="Av. do Exemplo" name="cEndereco" style="width: 300px;">
                           </div>
                           <div class="form-group">
                        ...
                        <form action="ClienteController" method="POST">
                           <div>
                                <input type="submit" class="btn btn-primary" name="showCliente" value="Show"> &nbsp; &nbsp;<br>
                           </div>
                        </form>
                    </div>
                    <!-- /.col-lg-12 -->
